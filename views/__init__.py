...
from .animal_requests import delete_animal, update_animal, get_animals_by_location
...
from .customer_requests import delete_customer, update_customer, get_customer_by_email
